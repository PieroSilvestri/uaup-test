...
const updateOptions = {
    gitRepo: "uaup-test", // [Required] Your Repo Name
    gitUsername: "munsra",  // [Required] Your GitHub Username.

    appName: "uaup-test-updater", //[Required] The Name of the app archive and the app folder.
    appExecutableName: "uaup-test-updater.exe", //[Required] The Executable of the Application to be Run after updating.
